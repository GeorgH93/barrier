...
class Action
{
    ...
    public:
        enum ActionType { keyDown, keyUp, keystroke, switchToScreen, switchInDirection, lockCursorToScreen, command, mouseDown, mouseUp, mousebutton };
    ...
    public:
        ...
        const QString& commandText() const { return m_Command; }
    ...
    protected:
        ...
        void setCommandText(const QString& cmd) { m_Command = cmd; }
